...
From the diagram emerge that \textit{Map Manager}, \textit{Virtual Queueing System} and the \textit{Visitors Manager} are the main components of the system since they are the ones
...
Many researchers have proposed a variety of different schemes for outdoor localization based on mobile devices. These schemes can be divided into two groups: range-based and range-free methods.
...
The cloud is the best solution for the machine learning algorithms it would use to do the calculations and it allows to scale the resources implied depending on the number of visitors.
