...
\begin{itemize}
	...
	resources to the edge elements. For instance, the database ID-Actions depicted in~\ref{fig:situated-recommendation} could be placed here since some actions can be sent to all the wearables independently from the visitor and therefore has no need for a tailored recommendation.
\end{itemize}
