...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{img/recommender.eps}
...
every location of interest is previously set and every time a visitor is near to it, on, the device or the system used to spot the presence send to the visitor's wearable its id.
