...
For instance, the avoiding long lines problem is faced with a \textbf{virtual queueing}\footnote{\url{https://en.wikipedia.org/wiki/Virtual_queue}} system
and there are many different solutions for recommendation and proximity marketing\footnote{\url{https://en.wikipedia.org/wiki/Proximity_marketing}}.
...
as well as Mirabilandia's current offers in terms of smart services.
...
devices and mobile apps for virtual queueing to several clients, mostly theme parks like the ``Six Flags'' corporation in the US
and ``LEGOLAND Windsor Resort'' in the UK but also for airports, skiing facilities, social distancing and so on.

Their motivation is:

Virtual queuing helps remove the number one frustration of guests (waiting in lines), increasing guest
satisfaction and revenue.
- https://www.accesso.com/learn/powering-positive-guest-experiences-with-virtual-queuing#:~:text=Unlike%20simpler%20ride,guests%E2%80%99%20mobile%20devices.

- https://www.accesso.com/learn/virtual-queuing-less-waiting-more-fun#:~:text=A%20dynamic%20virtual,Queue%20Management%20Solutions).

\subsubsection{Lo-Queue Virtual Queueing Products}
Their technology for virtual queueing is patented %TODO
