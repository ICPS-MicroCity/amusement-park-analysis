...
Firstly, since a Micro City -- and particularly its incarnation as an amusement park -- has the crucial ``queue'' concept, we searched for ``smart''
...
In addition to the features already listed for Prism, Qsmart gives also the possibility to easily make rides and
